...
- A bus-factor or key-person finding must match the bus-factor evidence: do not call a team with many contributors and no dominant author a low bus factor, and do not rate key-person risk above medium unless the scanner flagged it.
